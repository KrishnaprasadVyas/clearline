        ...
        >
          <motion.div variants={staggerItem}>
            <Link href="/" className="lp-nav-logo">
              <img src="/logo.png" alt="Clearline" className="lp-nav-logo-img" />
            </Link>
          </motion.div>
        ...
        <div className="lp-statement">
          ...
          <FadeUp delay={0.1}>
            <p className="lp-stmt-small">
              Severe congestion. The stark reality of Pune's healthcare.
            </p>
          </FadeUp>

          <FadeUp delay={0.2}>
            <div className="lp-stmt-block">
              <h2 className="lp-stmt-line">Pune's ERs are overwhelmed.</h2>
          ...
          >
            <div className="lp-browser-bar">
              ...
              <div className="lp-browser-url">
                ...
                <span>clearline.in/map</span>
              </div>
            </div>
            <div className="lp-browser-viewport">
              <iframe
                src="/map"
                title="Clearline Map Preview"
          ...
          features={[
            {
              ...
              content:
                "A live 3D map of Pune's emergency rooms. Congestion circles show real-time occupancy. Instantly see which ERs are overwhelmed and which have capacity.",
      ...
      <FadeUp>
        <footer className="lp-footer">
          <div className="lp-footer-inner">
            <span className="lp-footer-brand">Clearline</span>
            <span className="lp-footer-sep">&middot;</span>
            <span className="lp-footer-note">Built for Pune Hackathon 2026</span>
          </div>
        </footer>
      </FadeUp>
    </div>
