  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-[13px] font-bold text-slate-800 tracking-wide">Assets</h3>
        <div className="flex gap-2">
          <button
            onClick={() => setMergeMode(!mergeMode)}
            disabled={placementMode || buildings.length < 2}
            className={`px-4 py-1.5 rounded-full font-bold text-[11px] tracking-wide border transition-all duration-200 ease-out ${
              mergeMode
                ? 'bg-indigo-500 border-indigo-400 text-white shadow-[0_4px_12px_rgba(99,102,241,0.35)]'
                : 'bg-white/70 border-indigo-200 text-indigo-600 hover:bg-indigo-50 hover:border-indigo-300 hover:shadow-sm'
          ...
          <button
            ...
            className="px-4 py-1.5 rounded-full font-bold text-[11px] tracking-wide border-2 bg-indigo-50 border-indigo-200 text-indigo-700 hover:bg-indigo-100 hover:border-indigo-300 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        {buildings.map((building) => {
          ...
          return (
            <div
              key={building.id}
              className={`
                px-4 py-2.5 rounded-xl border cursor-pointer transition-all duration-200 ease-out
                ${isSelected
                  ? mergeMode
                    ? 'border-indigo-400 bg-indigo-50/80 shadow-[0_2px_12px_rgba(99,102,241,0.15)]'
                    : 'border-indigo-400 bg-indigo-50/80 shadow-[0_2px_12px_rgba(99,102,241,0.15)]'
                  : 'border-white/90 bg-white/50 hover:bg-white hover:shadow-sm'
                }
              `}
